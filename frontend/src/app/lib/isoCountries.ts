...
// Meta's "country" insights breakdown returns alpha-2 codes ("MA", "FR", …),
// while world-atlas/countries-110m keys its features by the numeric ISO code
// as a zero-padded string ("504", "250", "840"). Matching on the numeric code
// is robust against country-name spelling differences.
export const ALPHA2_TO_NUM: Record<string, string> = {
